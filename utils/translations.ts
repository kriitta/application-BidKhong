...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    auctionCreatedSub: "Your product has been submitted and is pending review.",
  ...
  th: {
    ...
    auctionCreatedSub: "สินค้าของคุณถูกส่งไปยังแอดมินเพื่อตรวจสอบ โปรดรอการอนุมัติสักครู่",
